...
public class SudokuGrid : MonoBehaviour
{
    ...
    private object grid_square_;

    public static SudokuGrid instance; // echo

    void Start()
    {
        if (grid_square.GetComponent<GridSquare>() == null)
        {
            Debug.LogError("This game objects needs to have GridSquare script attached");
        }
    ...
    void SetGridFromFile()
    {
        ...
        selected_grid_data = Config.ReadBoardGameLevel();  //check this
    ...
    private void SpawnGridSquares()
    {
        ...
        for (int row = 0; row < rows; row++)
        {
            for (int column = 0; column < columns; column++)
            {
                ...
                //grid_squares_[grid_squares_.Count - 1].transform.parent = this.transform; //instantiate this game object as the child of the object holding this script
    ...
    private void OnDisable()
    {
        ...
        if(GameSettings.Instance.GetExitAfterWon() == false) //do not save data when exit after completing board
        {
    ...
    public void GiveAHint()
    {
        ...
        // if no empty square on the board
    ...
    public void OnSquareSelected(int square_index)
    {
        ...
        //var vertical_line = LineIndicator.instance.GerVerticalLine(square_index);
        ...
        {
            // remove highlighting when selected
    ...
    public void SolveSudoku()
    {
        ...
        {
            var comp = squares.GetComponent<GridSquare>();
